...
const ProdReviews = () => {
  ...
  return (
    <Box className="w-full rounded-lg p-3 flex flex-col gap-5 border-2 border-solid border-gray-200 shadow-lg mt-5">
      <Box className="flex items-center justify-between font-medium">
        <span>Review ({20})</span>
      ...
      <Button
        variant="outlined"
        className="p-2 w-full bg-white mt-3 border-gray-400"
      ...
      <React.Fragment>
        ...
        >
          <DialogTitle id="responsive-dialog-title">Review (92)</DialogTitle>
          <IconButton
            aria-label="close"
          ...
          {!writeReview && (
            <DialogActions>
              <Button
                className="p-2 w-full bg-darkGreen mt-3"
